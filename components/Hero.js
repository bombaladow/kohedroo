...
export default function Hero({ settings }) {
  ...
  return (
    <section className="pt-32 pb-16 px-6 md:px-12 flex flex-col justify-between min-h-[85vh]">
      {/* قسم التعريف الرئيسي - About Me & Typography */}
      <div className="max-w-4xl">
        {/* شارة حالة التوافر (Badge) */}
        <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-md border border-black/10 px-4 py-1.5 rounded-full mb-6 shadow-sm">
        ...
        {/* الاسم / العنوان الرئيسي - حجم متناسق وأنيق */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-black leading-tight mb-6">
